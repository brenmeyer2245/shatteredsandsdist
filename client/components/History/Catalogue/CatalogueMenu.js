...
const CatalogueMenu = (props) => {
  ...
  return(
         <div className="history-catalogue-menu elevatedCard bg-primary flex font-DancingScript p-2 justify-content-center" title="Scroll down the papers above to see more items" >
            <div className="flex">
